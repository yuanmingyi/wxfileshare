...
obj.parseUserAgent = function (req) {
    var ua = req.headers['user-agent'].toLowerCase();
    var userAgent = { isMobile: false, inWechat: false, ieMobile: false };
    ...
    if (ua.indexOf('iemobile') !== -1) {
        userAgent.ieMobile = true;
    }
    if (ua.indexOf('micromessenger') !== -1) {
        userAgent.inWechat = true;
    }
    userAgent.uaString = req.headers['user-agent'];
    return userAgent;
}
